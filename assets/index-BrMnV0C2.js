...
`;var qe=Object.defineProperty,Ye=Object.getOwnPropertyDescriptor,te=(s,e,t,o)=>{for(var i=o>1?void 0:o?Ye(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(o?n(e,t,i):n(i))||i);return o&&i&&qe(e,t,i),i};let M=class extends m{constructor(){super(...arguments),this.activeSection="",this.isMenuOpen=!1,this.observer=null}firstUpdated(){const s={root:null,rootMargin:"-50% 0px -50% 0px",threshold:0};this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting&&(this.activeSection=o.target.id)})},s),this.shadowRoot?.querySelectorAll('a[href^="#"]')?.forEach(t=>{const o=t.getAttribute("href")?.substring(1),r=this.getRootNode().getElementById(o||"");r&&this.observer?.observe(r)})}disconnectedCallback(){super.disconnectedCallback(),this.observer?.disconnect()}toggleMenu(){this.isMenuOpen=!this.isMenuOpen,this.isMenuOpen?document.body.style.overflow="hidden":document.body.style.overflow=""}scrollToSection(s){s.preventDefault(),this.isMenuOpen&&this.toggleMenu();const t=s.target.getAttribute("href")?.substring(1);if(!t)return;const i=this.getRootNode().getElementById(t);if(!i)return;const r=60,n=i.getBoundingClientRect().top,a=window.scrollY+n-r;window.scrollTo({top:a,behavior:"smooth"}),history.pushState(null,"",`#${t}`)}render(){return y`
    ...
    `];te([ye()],M.prototype,"activeSection",2);te([ye()],M.prototype,"isMenuOpen",2);M=te([b("nav-bar")],M);const N=s=>{class e extends s{firstUpdated(o){super.firstUpdated(o),this._initScrollObserver()}_initScrollObserver(){const o={root:null,rootMargin:"0px",threshold:.1};this._observer=new IntersectionObserver(n=>{n.forEach(l=>{l.isIntersecting&&(l.target.classList.add("visible"),this._observer?.unobserve(l.target))})},o),this.shadowRoot?.querySelectorAll(".animate-on-scroll")?.forEach(n=>{this._observer?.observe(n)}),this.shadowRoot?.querySelectorAll("section")?.forEach(n=>{this._observer?.observe(n),n.classList.add("animate-on-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._observer?.disconnect()}}return e};var Fe=Object.getOwnPropertyDescriptor,Ve=(s,e,t,o)=>{for(var i=o>1?void 0:o?Fe(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let B=class extends N(m){render(){return y`
      <div class="container">
        <div class="hero-grid">
          <div class="hero-text">
            <h1 class="name">
    ...
    `];B=Ve([b("hero-section")],B);var Ge=Object.getOwnPropertyDescriptor,Je=(s,e,t,o)=>{for(var i=o>1?void 0:o?Ge(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let W=class extends m{render(){return y`
    ...
    `];q=Ke([b("community-section")],q);var Ze=Object.getOwnPropertyDescriptor,Qe=(s,e,t,o)=>{for(var i=o>1?void 0:o?Ze(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let Y=class extends m{render(){return y`
    ...
    `}};Y.styles=[_,u`
      ...
      .recognition-desc {
        ...
        line-height: 1.6;
      }`];Y=Qe([b("recognition-section")],Y);var et=Object.getOwnPropertyDescriptor,tt=(s,e,t,o)=>{for(var i=o>1?void 0:o?et(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let F=class extends N(m){render(){return y`
    ...
    `];F=tt([b("hobbies-section")],F);var it=Object.getOwnPropertyDescriptor,ot=(s,e,t,o)=>{for(var i=o>1?void 0:o?it(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let V=class extends N(m){render(){return y`
    ...
    `];V=ot([b("contact-section")],V);var st=Object.getOwnPropertyDescriptor,rt=(s,e,t,o)=>{for(var i=o>1?void 0:o?st(e,t):e,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let G=class extends m{render(){return y`
      <nav-bar></nav-bar>
      <main>
